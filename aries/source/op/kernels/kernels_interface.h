...
typedef void (*MHAKernel)(const tensor::Tensor& pos_tensor,
                   int32_t head_num, int32_t layer_index, int32_t seq_len,
                   int32_t kv_dim, int32_t kv_mul, int32_t head_size, 
                   const tensor::Tensor& mha_out, const tensor::Tensor& query, const tensor::Tensor& score,
...
typedef void (*RoPEKernel)(int dim, int kv_dim, int head_size, int rotary_dim, tensor::Tensor& input_q, 
